    ...
    <body>
        ...
        <section id="center">
            <section id="container">
                <section id="barre1">
                    <a id="Titre1">Evènement passés</a>
                    <button id="ajoutEvent">+</button>
                </section>

                <section id="Passé">
                    <section id="eventPassé1">
                        <a id="imageEvent">ImageEvent</a>
                        <a id="Nom">Titre Event</a>
                    </section>
                </section>

                <section id="barre2">
                    <a id="Titre2">A venir</a>
                </section>

                <section id="Futur">
                    <section class="event">
                        <a id="imageEvent">Image Event</a>
                        <a id="Nom">Titre Event</a>
                    </section>
