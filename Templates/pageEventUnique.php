    ...
    <body>
        ...
        <section id="main">
            ...
            <section id="evenement">
                ...
                <section id="imgEvent">
                    <a id="nomEvent">Nom évènement</a>
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLHDc_UjxkBOlQzFnF4CpcnsJjIvKhSZ3hB-Q7_0aOx1Iow2hC" alt="imageEvent"/>
                </section>

                <section id="bouton">
                    <button id="ajouterImage">Ajouter image à l'album</button>
                    <button id="Signal">Signaler</button>
                </section>
